...
@Table(name = "CassettePlayers")
public class CassettePlayer extends Model {
    ...
    @Column(name = "BeltMovement")
    public String beltMovement;
    ...
    public void setBeltMovement(String beltMovement) {
